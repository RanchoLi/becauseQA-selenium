 ...
 *
 */
public class PasteAction extends UIAction {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8143504712065515590L;
	 ...
	 *            main ui frame
	 */
	public PasteAction(SeleniumHelper frame) {
		super(frame);
		...
		putValue(NAME, res.getString("PasteAction.name"));
		putValue(SHORT_DESCRIPTION, res.getString("PasteAction.tooltip"));
		putValue(SMALL_ICON, new ImageIcon(
				Toolkit.getDefaultToolkit().createImage(getClass().getResource(res.getString("PasteAction.image")))));
	}
