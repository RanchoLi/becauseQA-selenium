...
public class RedoAction extends UIAction {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4222250163660845976L;
	 ...
	 *            main ui  frame
	 */
	public RedoAction(SeleniumHelper frame) {
		super(frame);

		String defaultName = res.getString("RedoAction.name");
		...
		putValue(SMALL_ICON, new ImageIcon(
				Toolkit.getDefaultToolkit().createImage(getClass().getResource(res.getString("RedoAction.image")))));
	}
